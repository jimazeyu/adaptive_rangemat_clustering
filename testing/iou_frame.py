...
if __name__ =='__main__':
    all_frame_path = './kitti/kitti_points_noground' #所有点云数据
    label_file_path = './kitti/kitti_labels_new/' #标注数据的文件夹地址
    cluster_file_path = './results/kitti_clustering.txt'#算法输出文件的地址
    IOU_3D = result()
